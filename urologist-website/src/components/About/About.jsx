  ...
  return (
    <section className="bg-white text-gray-800 py-16 px-6 md:px-20 flex flex-col md:flex-row items-center">
      ...
      <div className="md:w-1/2 space-y-4 text-left">
        <h2 className="text-blue-700 text-3xl font-bold">Dr. Kunjan Kumar</h2>
        <h3 className="text-2xl font-extrabold">BEST UROLOGIST IN Patna</h3>
        ...
        <p className="text-gray-600">
          Dr. Kunjan Kumar is one of the best urologist in Patna he did his MBBS
          ...
          robotic surgeries by a distinguished world-class faculty. Dr. Kunjan
          Kumar Clinic provides the best urology treatments in Patna with a
